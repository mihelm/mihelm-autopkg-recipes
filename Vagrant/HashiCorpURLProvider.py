...
class HashiCorpURLProvider(Processor):
    ...
    output_variables = {
        ...
        "version": {
            "description": "Version of the latest project release.",
        },
    }
    description = __doc__
    ...
    def get_version_number(self, base_url, operating_system, architecture):
    ...
    def main(self):
        ...
        self.env["version"] = self.get_version_number(base_url, operating_system, architecture)
